...
class Order(models.Model):
    ...
    parent_order_id = models.UUIDField(blank=True, null=True, db_comment="indicate if it's a backorder")
    ...
    updated_at = models.DateTimeField(blank=True, null=True, db_comment='UTC', default=django.utils.timezone.now)
