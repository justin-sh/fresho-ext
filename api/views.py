...
def init_orders(request):
    ...
    data = {'supplier_orders': [
        {'additional_notes': None, 'contact_name': 'Gilbert Street Hotel', 'contact_phone': '8231 9909',
         ...
         'may_mark_as_paid': True, 'receiving_company_id': '83d7ec7e-a03d-45f2-ac7b-569905a42f7c', 'status_icons': '',
         'has_credit_card_fee': False, 'receiving_company_name': 'Gilbert Street Hotel',
         'placed_by_name': 'qian zhang'}, {'additional_notes': None, 'contact_name': 'Mugen House City, Zhenghan Jiang',
...
@api_view(['GET', 'POST'])
@permission_classes((permissions.AllowAny,))
def upload_orders(request: Request):
    logger.info("---------")
    logger.info("---------")
    logger.info("---------")
    logger.info("---------")
